...
Görebileceğimiz üzere Once olanlar tamamlandıktan sonra normalleri çalıştırılır.
Kendi aralarında ise tanımlandıkları sıraya riayet ederler. `factory`
parametresinin kritik özellikleriyle bölümü noktalayalım:
