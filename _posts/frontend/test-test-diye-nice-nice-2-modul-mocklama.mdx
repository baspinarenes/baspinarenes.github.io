...
- Test Test Diye Nice Nice: Mocklama - 2: Modül Mocklama (Şu anda buradasınız)
...
mocklayacağımızdan bahsettik. Peki ya modüllerden export ettiğimiz 
fonksiyonları nasıl mocklayabiliriz? Konumuza geçmeden öncesinde modüle kısacık 
değinelim.
...
> `any` kullandığımı görebilirsiniz. E bazen de kullanılır.
