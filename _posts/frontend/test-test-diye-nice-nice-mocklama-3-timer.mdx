...
tamamlanacağını testimize belirtmemiz gerekir.

<CH.Section>
```javascript callAfterThreeSeconds.test.ts focus=9:13
import callAfterThreeSeconds from "./callAfterThreeSeconds";
...
Sona gelirken sizi çok zorlamayacak bir final boss bırakıyorum. Çıktıdan 
case'lere bakarak testleri kendiniz yazmaya çabalamanızı tavsiye ederim çünkü 
çok şey öğrenilen anlar çoğunlukla en çok zorlanılan zamanlar oluyor. 
Takılırsanız ikinci sekmeden testlerin tamamlanmış haline bakabilirsiniz.
