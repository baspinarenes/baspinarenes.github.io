...
date: 2020-06-16
category: Ubuntu
description: Ubuntu'nun varsayılan terminaline bakınca sizinde içiniz kararıyor değil mi? Öyleyse terminalimize biraz renk katalım.
---
...
<LargeImage src="terminale-renk-katalim-001.webp" />

Harika, değil mi? Ubuntu'nun varsayılan terminali ile karşılaştırmak isterseniz:

<LargeImage src="terminale-renk-katalim-002.webp" />
...
<LargeImage src="terminale-renk-katalim-003.webp" />
...
<LargeImage src="terminale-renk-katalim-004.webp" />
...
<LargeImage src="terminale-renk-katalim-005.webp" />
...
<LargeImage src="terminale-renk-katalim-006.webp" />
...
<LargeImage src="terminale-renk-katalim-007.webp" />

Terminali kapatıp açtığımızda ekranımız aşağıdaki gibi gözükmelidir:

<LargeImage src="terminale-renk-katalim-008.webp" />
...
<LargeImage src="terminale-renk-katalim-009.webp" />
...
<LargeImage src="terminale-renk-katalim-010.webp" />

Terminali kapatıp açtığımızda görüntü aşağıdaki gibi olmalıdır:

<LargeImage src="terminale-renk-katalim-011.webp" />
...
<LargeImage src="terminale-renk-katalim-012.webp" />
